...
// A Solana RPC URL, must allow getProgramAccounts requests.
...
async fn main() {
    ...
    let account_equities_file_path = format!("account_equities_{}.json", cur_ts.as_secs());
    ...
    let wallet_equities_file_path = format!("wallet_equities_{}.json", cur_ts.as_secs());
